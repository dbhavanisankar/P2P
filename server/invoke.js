...
console.log("Contracts Received:"+fnName);
    
var function_name = fnName;
var arg2 = JSON.stringify(jsonblob);

console.log("Payload Received:"+arg2);
        var options = {
        wallet_path: path.join(__dirname, './hfc-key-store'),
        user_id: 'PeerAdmin',
        channel_id: 'mychannel',
        chaincode_id: 'P2P',
        peer_url: 'grpcs://nc72ac8e335ef4507a137de7a1a2fe4ea-org1-peer1.us05.blockchain.ibm.com:31002',
        event_url: 'grpcs://nc72ac8e335ef4507a137de7a1a2fe4ea-org1-peer1.us05.blockchain.ibm.com:31003',
        orderer_url: 'grpcs://nc72ac8e335ef4507a137de7a1a2fe4ea-orderer.us05.blockchain.ibm.com:31001'
    };
...
// send proposal to endorser
    ...
    if (isProposalGood) {
		...
		console.log("data  dfsdfsdfsdf:::"+JSON.stringify(response));
        ...
        //call the blockactivity request jax
       //   fnName = "trackblockactivity";
        // blockactivitytrack.queryblockSDK(fnName,tx_id.getTransactionID(),reply);
          reply.send(ret_json);
    } else {
